...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role", postgresql.ENUM("user", "admin", name="userroleenum", create_type=False), nullable=False
        ),
    ...
    op.create_index(
        "idx_house_communities_city_region", "house_communities", ["city", "region"], unique=False
    )
    op.create_index(
        "idx_house_communities_location", "house_communities", ["latitude", "longitude"], unique=False
    )
    ...
    op.create_index(
        "idx_house_price_history_house_recorded",
        "house_price_history",
    ...
    op.create_index(
        "idx_house_hospitals_location", "house_hospitals", ["latitude", "longitude"], unique=False
    )
    ...
    op.create_index(
        "idx_house_bus_stops_location", "house_bus_stops", ["latitude", "longitude"], unique=False
    )
    ...
    op.create_index(
        "idx_house_school_links_composite", "house_school_links", ["house_id", "school_id"], unique=False
    )
    ...
    op.create_index(
        "idx_house_hospital_links_hospital", "house_hospital_links", ["hospital_id"], unique=False
    )
