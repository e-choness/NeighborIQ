...
SQUARE = {
    "type": "Polygon",
    "coordinates": [[[-79.40, 43.60], [-79.39, 43.60], [-79.39, 43.61], [-79.40, 43.61], [-79.40, 43.60]]],
}
...
def test_property_lookup(client, db):
    items = client.get("/api/v1/properties/lookup", params={"q": "12 que", "city": "Placeville"}).json()[
        "items"
    ]
