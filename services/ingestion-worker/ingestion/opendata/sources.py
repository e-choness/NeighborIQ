...
class Source:
    ...
    url: str | None = None
    resolver: tuple | None = (
        None  # ("ckan", base, package, formats) | ("ods", domain, dataset, fmt) | ("socrata", domain, title, fmt)
    )
...
SOURCES: dict[str, Source] = {
    ...
    for s in [
        ...
        Source(
            ...
            options={
                "name_fields": ["AREA_NAME", "AREA_DESC"],
                "code_fields": ["AREA_SHORT_CODE", "AREA_LONG_CODE"],
            },
        ),
        Source(
            "vancouver_areas",
        ...
        Source(
            ...
            "areas",
            OGL_OTTAWA,
            "Ottawa Neighbourhood Study; City of Ottawa Open Data",
        ...
        Source(
            ...
            "areas",
            CC_MONTREAL,
            "Ville de Montréal, données ouvertes (CC BY 4.0)",
        ...
        Source(
            "vancouver_assessments",
            "Vancouver",
            "assessments",
            OGL_VANCOUVER,
            "City of Vancouver property tax report",
        ...
        Source(
            ...
            "assessments",
            OGL_CALGARY,
            "City of Calgary property assessments",
        ...
        Source(
            ...
            "assessments",
            OGL_EDMONTON,
            "City of Edmonton property assessment data",
            resolver=(
                "socrata",
                "data.edmonton.ca",
        ...
        Source(
            "montreal_assessments",
            "Montreal",
            "assessments",
            CC_MONTREAL,
            "Ville de Montréal, unités d'évaluation foncière (CC BY 4.0)",
        ...
        Source(
            ...
            "Toronto",
            "incidents",
            "Toronto Police Service Open Data Licence",
        ...
        Source(
            ...
            "Vancouver",
            "gtfs",
            "TransLink Transit Data Terms of Use",
            "TransLink",
